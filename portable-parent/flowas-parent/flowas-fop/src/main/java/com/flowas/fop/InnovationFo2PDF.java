...
public class InnovationFo2PDF {
	private static String inputxml = "src/main/docbook/zh_CN/sciencePreview/master.xml";
	//private static String inputxml = "xml/xslt/docsrc/reference.xml";
	private static String single_page = "src/main/docbook/zh_CN/sciencePreview/single_page.xml";
	...
	public static void main(String[] args) throws IOException,
		...
		InnovationFo2PDF app = new InnovationFo2PDF();
		app.generateDoc();
	}
	...
	private void generateDoc() throws IOException, TransformerException,
		...
		File fofile = new File(outDir, "sciencePreview.fo");
		...
		File distinctfile = new File(outDir, "sciencePreview.pdf");
